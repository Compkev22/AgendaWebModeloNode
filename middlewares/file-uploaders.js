...
export const uploadContactImage = createCloudinaryUploader(
    process.env.CLOUDINARY_FOLDER || 'agenda_web/Contact'
);
 
// Uploader para imágenes de Equipos deportivos
export const uploadToDoListImage = createCloudinaryUploader(
    process.env.CLOUDINARY_TEAMS_FOLDER || 'agenda_web/ToDoList'
);
